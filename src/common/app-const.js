...
export const DEATH_AGE_CHANGE_RANGES = [
...
export const STRUCTURES = [
    ...
    },
    {
        ...
        max: -1,
        maxWorkers: 2,
        description: ['Establish a quarry by cutting into nearby granite deposits.'],
        cost: [
...
export const PROFESSIONS = [
    {
        ...
        description: 'Gathers nuts, berries, mushrooms, and roots by searching nearby forests.'
    },
    {
